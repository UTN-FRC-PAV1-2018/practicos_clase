    ...
    public partial class frmBugs : Form
    {
        ...
        private void btn_editar_Click(object sender, EventArgs e)
        {
            ...
            if (row_selected.Index != -1)
            {
                ...
                //Ejecutamos el evento Click para que actualice la grilla de bugs.
        ...
        {
            if (MessageBox.Show("Seguro que desea cerrar el Bug?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                int id;
                if (row_selected.Index != -1)
                {
        ...
        {
            if (MessageBox.Show("Seguro que desea pasar el Bug a Testing?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                int id;
                if (row_selected.Index != -1)
                {
